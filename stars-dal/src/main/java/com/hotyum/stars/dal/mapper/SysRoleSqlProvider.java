...
import com.hotyum.stars.dal.model.SysRoleExample.Criteria;
import com.hotyum.stars.dal.model.SysRoleExample.Criterion;
...
public class SysRoleSqlProvider {
    ...
    public String insertSelective(SysRole record) {
        ...
        if (record.getDefaultRole() != null) {
            sql.VALUES("default_role", "#{defaultRole,jdbcType=TINYINT}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getDefaultRole() != null) {
            sql.SET("default_role = #{record.defaultRole,jdbcType=TINYINT}");
        }
    ...
    public String updateByPrimaryKeySelective(SysRole record) {
        ...
        if (record.getDefaultRole() != null) {
            sql.SET("default_role = #{defaultRole,jdbcType=TINYINT}");
        }
