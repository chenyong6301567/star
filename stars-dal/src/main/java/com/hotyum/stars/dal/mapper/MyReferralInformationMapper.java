...
public interface MyReferralInformationMapper {
    ...
    @Insert({
        ...
        "#{starDegree,jdbcType=VARCHAR}, #{sumMoney,jdbcType=DECIMAL}, ",
    ...
    @Results({
        ...
        @Result(column="star_degree", property="starDegree", jdbcType=JdbcType.VARCHAR),
    ...
    @Update({
        ...
        "set us_id = #{usId,jdbcType=INTEGER},",
          ...
          "star_degree = #{starDegree,jdbcType=VARCHAR},",
