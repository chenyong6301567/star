...
public interface UserMapper {
    ...
    @Insert({
        ...
        "number_agents, direct_recommendation_account, ",
        ...
        "values (#{account,jdbcType=INTEGER}, #{pwd,jdbcType=VARCHAR}, ",
        ...
        "#{numberAgents,jdbcType=VARCHAR}, #{directRecommendationAccount,jdbcType=INTEGER}, ",
        "#{indirectRecommendationAccount,jdbcType=INTEGER}, #{certificateType,jdbcType=TINYINT}, ",
    ...
    @Results({
        ...
        @Result(column="number_agents", property="numberAgents", jdbcType=JdbcType.VARCHAR),
        @Result(column="direct_recommendation_account", property="directRecommendationAccount", jdbcType=JdbcType.INTEGER),
        @Result(column="indirect_recommendation_account", property="indirectRecommendationAccount", jdbcType=JdbcType.INTEGER),
    ...
    @Select({
        ...
        "gmt_modify, status, referee_qualification, number_agents, direct_recommendation_account, ",
    ...
    @Update({
        ...
        "set account = #{account,jdbcType=INTEGER},",
          ...
          "number_agents = #{numberAgents,jdbcType=VARCHAR},",
          "direct_recommendation_account = #{directRecommendationAccount,jdbcType=INTEGER},",
          "indirect_recommendation_account = #{indirectRecommendationAccount,jdbcType=INTEGER},",
