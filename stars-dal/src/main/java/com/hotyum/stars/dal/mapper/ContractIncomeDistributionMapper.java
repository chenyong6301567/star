...
public interface ContractIncomeDistributionMapper {
    ...
    @Select({
        "select",
        "id, document_code, customer_name, investment_amount, contract_income, trade_platform, ",
        "trade_account, first_trade_date, product_type_id, product_type_name, trade_end_date, ",
