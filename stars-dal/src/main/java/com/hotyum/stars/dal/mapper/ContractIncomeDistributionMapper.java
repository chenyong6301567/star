...
public interface ContractIncomeDistributionMapper {
    ...
    @Select({
        ...
        "derect_recomand_person_id, derect_recomand_person_name, inderect_recomand_person_id, ",
        "inderect_recomand_person_name, derect_recomand_rate, inderect_recomand_rate, ",
